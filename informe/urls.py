...
urlpatterns = [
    ...
    path('clientes/editar/<str:pk>/', views.editar_cliente, name='editar_cliente'),
    path('clientes/eliminar/<str:pk>/', views.eliminar_cliente, name='eliminar_cliente'),

    path('mecanicos/', views.lista_mecanicos, name='lista_mecanicos'),
    path('mecanicos/crear/', views.crear_mecanico, name='crear_mecanico'),
    path('mecanicos/editar/<str:pk>/', views.editar_mecanico, name='editar_mecanico'),
    path('mecanicos/eliminar/<str:pk>/', views.eliminar_mecanico, name='eliminar_mecanico'),

    path('cargos/', views.lista_cargos, name='lista_cargos'),
    path('cargos/crear/', views.crear_cargo, name='crear_cargo'),
    path('cargos/editar/<str:pk>/', views.editar_cargo, name='editar_cargo'),
    path('cargos/eliminar/<str:pk>/', views.eliminar_cargo, name='eliminar_cargo'),
